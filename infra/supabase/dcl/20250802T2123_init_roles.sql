...
-- ==============================================
-- USER: prisma_dev_cr Cloud Run 用
-- ==============================================

CREATE USER prisma_dev_cr WITH PASSWORD '${PRISMA_DEV_CR_PASSWORD}' BYPASSRLS CREATEDB;

GRANT prisma_dev_cr TO postgres;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public
  GRANT SELECT ON TABLES TO prisma_dev_cr;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public
  GRANT EXECUTE ON FUNCTIONS TO prisma_dev_cr;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public
  GRANT USAGE, SELECT ON SEQUENCES TO prisma_dev_cr;

-- SCHEMA: dev（full access）
GRANT USAGE ON SCHEMA dev TO prisma_dev_cr;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA dev TO prisma_dev_cr;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA dev TO prisma_dev_cr;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA dev TO prisma_dev_cr;

ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA dev
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO prisma_dev_cr;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA dev
  GRANT EXECUTE ON FUNCTIONS TO prisma_dev_cr;
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA dev
...
-- SCHEMA: test（full access）
GRANT USAGE ON SCHEMA test TO prisma_dev_cr;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA test TO prisma_dev_cr;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA test TO prisma_dev_cr;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA test TO prisma_dev_cr;

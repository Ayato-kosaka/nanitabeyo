...
export class UsersController {
  ...
  async getUserDishReviews(
    ...
    const items = await this.usersService.getUserDishReviews(id, query, user?.userId);
  ...
  async getMeLikedDishMedia(
    ...
    const items = await this.usersService.getMeLikedDishMedia(query, user?.userId);
  ...
  async getMePayouts(
    ...
    const items = await this.usersService.getMePayouts(query, user.userId);
  ...
  async getMeRestaurantBids(
    ...
    const items = await this.usersService.getMeRestaurantBids(query, user.userId);
  ...
  async getMeSavedDishCategories(
    ...
    const items = await this.usersService.getMeSavedDishCategories(query, user?.userId);
  ...
  async getMeSavedDishMedia(
    ...
    const items = await this.usersService.getMeSavedDishMedia(query, user?.userId);

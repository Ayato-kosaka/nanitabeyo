...
export type Database = {
	...
	dev: {
		...
		Functions: {
			...
			st_dump: {
				Args: { "": unknown };
				Returns: Database["dev"]["CompositeTypes"]["geometry_dump"][];
			};
			st_dumppoints: {
				Args: { "": unknown };
				Returns: Database["dev"]["CompositeTypes"]["geometry_dump"][];
			...
			st_isvaliddetail: {
				...
				Returns: Database["dev"]["CompositeTypes"]["valid_detail"];
			};
			st_isvalidreason: {
				Args: { "": unknown };
				Returns: string;
		...
		Enums: {
			backend_event_logs_error_level: "verbose" | "debug" | "log" | "warn" | "error";
			frontend_event_logs_error_level: "verbose" | "debug" | "log" | "warn" | "error";

...
interface FoodContentScreenProps {
	...
	/** Whether this content is currently active (for video playback control) */
	isActive?: boolean;
}
...
export default function FoodContentScreen({ item, carouselRef, isActive }: FoodContentScreenProps) {

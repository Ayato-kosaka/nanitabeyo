 ...
 */
export const TopicThumbnail = React.memo(function TopicThumbnail({
	topic,
	index,
	total,
	isActive,
	...
	const handleImageError = useCallback(() => onImageError(topic), [onImageError, topic]);

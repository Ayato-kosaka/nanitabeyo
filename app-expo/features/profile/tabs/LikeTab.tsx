...
export function LikeTab() {
        ...
        const { items, loadInitial, loadMore, refresh, error, isLoadingInitial, isLoadingMore } =
                useCursorPagination<QueryMeLikedDishMediaDto, DishMediaEntry>(
                        useCallback(
                                async ({ cursor }) => {

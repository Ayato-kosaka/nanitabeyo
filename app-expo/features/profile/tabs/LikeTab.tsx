...
export function LikeTab() {
	...
	useEffect(() => {
		const currentData = getCurrentDishMediaEntriesForTab("liked");
		if (currentData === null) {
			loadInitialData("liked");
		}
	}, []);
	...
	const handleDishMediaEntryPress = (item: DishMediaEntry) => {
		...
		logFrontendEvent({
			...
			error_level: "log",
			payload: { item, selectedTab: "liked" },
		});
	};
	...
	function renderEmptyState() {
		const tabError = fetchErrors.liked;
			...
			return (
				<View style={styles.emptyStateContainer}>
					<View style={styles.emptyStateCard}>
						...
						<TouchableOpacity style={styles.retryButton} onPress={() => refreshData("liked")}>

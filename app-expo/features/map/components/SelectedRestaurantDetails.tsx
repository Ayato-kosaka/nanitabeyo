...
export function SelectedRestaurantDetails({ selectedPlace }: Props) {
        ...
        const renderTabBar = useCallback(
                (props: TabBarProps<string>) => <RestaurantTabsBar {...props} />,
                [],
        );
        ...
        return (
                <View style={styles.container}>
                        ...
                        <ReviewBlurModal>
                                {({ close }) => (
                                        <ReviewForm onSubmit={handleReviewSubmit} onCancel={close} isProcessing={isProcessing} />
                                )}
                        </ReviewBlurModal>
                        ...
                        <BidBlurModal>
                                {({ close }) => (
                                        <BidForm onSubmit={handleBid} onCancel={close} isProcessing={isProcessing} />
                                )}
                        </BidBlurModal>
                </View>
        );

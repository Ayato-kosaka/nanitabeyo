...
function blank(src) {
  ...
  while (i < src.length) {
    ...
    if (c === '"' || c === "'" || c === "`") {
      ...
      while (i < src.length) {
        if (src[i] === "\\") { out[i] = keep(i); out[i + 1] = keep(i + 1); i += 2; continue; }

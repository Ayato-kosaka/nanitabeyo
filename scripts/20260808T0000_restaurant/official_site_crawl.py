...
#
# つまり **`country_code = 'JP'` が誤っていた**。原因は `3_4_build_restaurant_catalog.py`
# が **緯度経度の矩形**（lat 20.0-46.5 / lon 122.0-154.0）で国を決めていたことで、
# この矩形には朝鮮半島もウラジオストクもまるごと入る（#1881 で起票し、
# `country_resolution.py` が **住所から**決める形へ直した）。
#

...
■ 本スクリプトの特徴
- 設定は 5_2_gcp_config_production.yaml に集約（環境変数は最小化）
...
■ 使い方（例）
  ...
  python 5_2_enqueue_image_resizes_production.py --pg-url "..." --config ./5_2_gcp_config_production.yaml --dry-run
...
def main():
    ...
    parser.add_argument("--config", default="./5_2_gcp_config_production.yaml", help="設定ファイル（YAML）のパス")
